...
var imageSlider=new mcImgSlider(sliderOptions);
		...
		function mcImgSlider(k){
			for(var T=function(a){ return document.getElementById(a) },
			d="length",
									...
									q:function(){
										...
										Db=function(){
											...
											fb=function(){
												...
												if(f)
													a.m=Math.ceil(f.offsetHeight*a.g/f[X]);qb(k.effect);
													a.n=function(){
														var b;
														if(a.a.p==-1)
